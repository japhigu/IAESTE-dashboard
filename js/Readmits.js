...
queue()
        //.defer(d3.json, "testdata/readmitnodes.php")
        //.defer(d3.json, "testdata/readmitlinks.php")
        .defer(d3.json, "testdata/readmitnodes.json")
        .defer(d3.json, "testdata/readmitlinks.json")
        .await(readmissions); 
