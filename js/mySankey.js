...
queue()
    //.defer(d3.json, "testdata/sankeyLinks.php")
    //.defer(d3.json, "testdata/sankeyNodes.php")
    .defer(d3.json, "testdata/sankeyLinks.json")
    .defer(d3.json, "testdata/sankeyNodes.json")
    .await(ready);
